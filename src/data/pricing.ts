    ...
    plans: [
      {
        name: "Starter",
        price: "1.452 €",
        note: "IVA incluido · pago único",
        desc: "Web de una página",
        featured: false,
        cta: "Elegir Starter",
        feats: [
      ...
      },
      {
        ...
        price: "2.420 €",
        note: "IVA incluido · pago único",
        desc: "Hasta 6 páginas",
        featured: true,
        cta: "Elegir Business",
        feats: [
          "Todo lo de Starter",
          "Apoyo con los textos",
    ...
    plans: [
      {
        name: "Starter",
        price: "1 452 €",
        note: "НДС включён · разовый платёж",
        desc: "Одностраничный сайт",
        featured: false,
        cta: "Выбрать Starter",
        feats: [
          "Индивидуальный дизайн одной страницы",
          "Форма связи и карта",
